...
export default function ClientAppIframePreview({ clientId, prenom, onClose }) {
    ...
    <div className="cap-overlay" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="cap-shell">
        ...
        <p className="cap-footer">
          Token preview valable 1h · session isolée de l'app cliente · lecture seule recommandée.
        </p>
      </div>
