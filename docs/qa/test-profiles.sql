...
INSERT INTO clients (
  ...
  jsonb_build_object(
    ...
    'age', '35', 'genre', 'Femme', 'profession', 'Cheffe de projet marketing',
    'poids', '64', 'taille', '168',
    'tourTaille', '78', 'tourHanche', '98', 'tourPoitrine', '90',
    'tourBras', '28', 'tourCuisse', '56',
    'masseGrasse', '26', 'masseMusculaire', '',
    'telephone', '+41 79 000 00 01', 'email', 'qa-digestion@test.ch',
    ...
    'contraception', 'Stérilet cuivre', 'cycleDuree', '28 jours',
    ...
    'typeSport', 'Yoga + marche rapide', 'frequenceSport', '2-3×/semaine',
    'objectifSport', 'Retrouver de l''énergie, gérer le stress',
    'recuperation', 'Correcte', 'supplements', 'Magnésium ponctuellement',
    ...
    'reactionGlucides', jsonb_build_array('coup_de_pompe_post_repas', 'fringales_sucre'),
    ...
    'consommationReguliere', jsonb_build_array('cafe', 'produits_transformes'),
...
INSERT INTO clients (
  ...
  jsonb_build_object(
    ...
    'age', '29', 'genre', 'Femme', 'profession', 'Infirmière (horaires variables)',
    'poids', '72', 'taille', '165',
    'tourTaille', '88', 'tourHanche', '104', 'tourPoitrine', '94',
    'tourBras', '31', 'tourCuisse', '62',
    'masseGrasse', '32', 'masseMusculaire', '',
    'telephone', '+41 79 000 00 02', 'email', 'qa-sopk@test.ch',
    ...
    'operations', 'Aucune', 'allergies', 'Aucune',
    ...
    'reactionGlucides', jsonb_build_array('coup_de_pompe_post_repas', 'fringales_sucre', 'prise_de_poids_abdominale'),
    ...
    'consommationReguliere', jsonb_build_array('laitages', 'cafe', 'produits_transformes'),
    ...
    'alcool', 'Rare, 1-2 verres/mois', 'tabac', 'Non',
...
INSERT INTO clients (
  ...
  jsonb_build_object(
    'prenom', 'Marc', 'nom', 'Rossi',
    'age', '42', 'genre', 'Homme', 'profession', 'Cadre financier',
    'poids', '98', 'taille', '182',
    'tourTaille', '108', 'tourHanche', '110', 'tourPoitrine', '115',
    'tourBras', '36', 'tourCuisse', '62',
    'masseGrasse', '28', 'masseMusculaire', '',
    'telephone', '+41 79 000 00 03', 'email', 'qa-pertepoids@test.ch',
    ...
    'alimentsEvites', 'Rien',
    'hydratation', '1L/j', 'mastication', 'Rapide',
    ...
    'contraception', '', 'cycleDuree', '', 'spm', '',
    'douleursMenstruelles', '', 'projetGrossesse', '',
    ...
    'recuperation', 'OK', 'supplements', 'Aucun',
    'digestifEffort', 'Pas de trouble',
    ...
    'reactionGlucides', jsonb_build_array('prise_de_poids_abdominale'),
    'frequenceBallonnements', 'Occasionnels après repas copieux',
    'transitType', 'Régulier',
    'alimentsProblematiques', 'Aucun',
    'consommationReguliere', jsonb_build_array('cafe', 'produits_transformes', 'alcool'),
    ...
    'etatReveil', 'Correct',
    'tempsExterieur', '30 min/j', 'heuresSommeil', '7h',
    'expositionEcransSoir', 'Oui, TV jusqu''à 23h',
    'professionType', 'Assis bureau, déplacements occasionnels',
    'alcool', '3-4 verres de vin/semaine + apéro week-end', 'tabac', 'Non',
