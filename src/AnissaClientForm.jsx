        ...
        <div className="nutrition-form-section">
          ...
          <div className="form-grid">
            ...
            <div className="field full-width"><label>Apres un repas copieux, vous ressentez</label>
              <div className="radio-group">{['Energie stable', 'Somnolence', 'Ballonnements', 'Faim rapide'].map(opt => (<label key={opt} className="radio-label"><input type="radio" name="reactionGlucides" value={opt} checked={form.reactionGlucides === opt} onChange={e => updateField('reactionGlucides', e.target.value)} /><span>{opt}</span></label>))}</div>
            </div>
